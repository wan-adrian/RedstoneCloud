...
public record ServerData(String name, UUID uuid, String template, String status, String serverType, int port, boolean proxy, JsonArray connectedPlayers, JsonObject extraData, String nodeId) {
